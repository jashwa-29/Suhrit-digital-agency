...
const GetToKnowUs = () => {
  return (
    <div>
      <section className="lg:w-11/12 w-full mx-auto  font-jakarta flex flex-col lg:flex-row lg:items-center justify-between py-10 lg:py-20 lg:px-8 px-8">
        <div className="  text-center lg:text-left">
          ...
          <p className="text-[#636262] leading-[24px] tracking-[0.2px] w-full lg:w-[680px] pb-5">
          At Suhrit, we excel in delivering comprehensive digital marketing and technology consulting solutions. 
          Our expertise in SEO, social media, content creation, and tech-driven strategies empower businesses to thrive in an evolving digital landscape.
          </p>
